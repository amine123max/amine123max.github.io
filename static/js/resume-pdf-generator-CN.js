      ...
      <div class="resume-container">
        ...
        <div class="header">
          ...
          <div class="contact-info">
            <div class="contact-item"><strong>邮箱：</strong> ${data.personal.email}</div>
            <div class="contact-item"><strong>地点：</strong> ${data.personal.organization}</div>
            <div class="contact-item"><strong>GitHub：</strong> <a href="${data.personal.github}">amine123max</a></div>
            <div class="contact-item"><strong>网站：</strong> <a href="https://amine123max.github.io/">amine123max.github.io</a></div>
          </div>
        </div>
