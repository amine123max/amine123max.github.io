...
// Initialize English PDF Generator
function initResumePDFGeneratorEN() {
  ...
  if (downloadBtn) {
    ...
    console.log('Found download button, attaching EN event listener');
    newBtn.addEventListener('click', function(e) {
      e.preventDefault();
      e.stopPropagation();
      console.log('[EN] Download button clicked');
      generatePDF();
    });
  } else {
...
// English version - will be called by main script
